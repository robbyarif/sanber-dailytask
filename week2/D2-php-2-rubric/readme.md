# Day#2 Week 2 - PHP part 2

## Objectives

Create a directory named `php-2` inside `htdocs` of XAMPP.

Create and solve problems in `looping.php` below
...
Create and solve problems in `function-conditional.php` below
