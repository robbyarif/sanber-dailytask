# Day#1 Week 2 - PHP part 1

## Objectives

Create a directory named `php-1` inside `htdocs` of XAMPP.

Solve problems inside template named `string.php` below
```
<!DOCTYPE html>
<html lang="en">
<head>
...
Solve problems in template `array.php` below
```
<!DOCTYPE html>
<html lang="en">
